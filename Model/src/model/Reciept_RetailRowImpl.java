...
public class Reciept_RetailRowImpl extends ViewRowImpl {
    ...
    public static final int COA_BANK_AND_PARTYALL1 = AttributesEnum.COA_Bank_And_PartyAll1.index();
    ...
    /**
     * Gets the view accessor <code>RowSet</code> COA_Bank_And_PartyAll1.
     */
    public RowSet getCOA_Bank_And_PartyAll1() {
        RowSet rs1 = (RowSet)getAttributeInternal(COA_BANK_AND_PARTYALL1);
                 rs1.executeQuery();
                 return rs1;
      //  return (RowSet) getAttributeInternal(COA_BANK_AND_PARTYALL1);
    }
